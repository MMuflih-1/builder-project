...
const handler = async (event) => {
    try {
        ...
        // Call Amazon Bedrock Nova for image generation
        ...
        const input = {
            ...
            body: JSON.stringify({
                ...
                textToImageParams: {
                    text: enhancedPrompt,
                    negativeText: 'blurry, low quality, cartoon, anime, drawing, sketch, multiple dogs, cats, other animals',
                },
        ...
        const filename = `generated/dog-${timestamp}.png`;
        // Upload to S3
